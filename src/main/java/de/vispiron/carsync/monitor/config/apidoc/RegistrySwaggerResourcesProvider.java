package de.vispiron.carsync.monitor.config.apidoc;
...
@Component
@Primary
@Profile(MicroMonitorConstants.SPRING_PROFILE_SWAGGER)
public class RegistrySwaggerResourcesProvider implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        //Add the registry swagger resource that correspond to the microservice's own swagger doc
        resources.add(swaggerResource("microservice", "/v2/api-docs"));
