package de.vispiron.carsync.monitor.library.security.uaa;
...
public class UaaAutoConfiguration {
    ...
    private MicroMonitorProperties NgMcmonitorProperties;

    public UaaAutoConfiguration(MicroMonitorProperties monitorProperties) {
        this.NgMcmonitorProperties = monitorProperties;
    }
    ...
    public LoadBalancedResourceDetails loadBalancedResourceDetails(LoadBalancerClient loadBalancerClient) {
        ...
        MicroMonitorProperties.Security.ClientAuthorization clientAuthorization = NgMcmonitorProperties.getSecurity()
